...
## Operacion AIX con calma

En AIX, comandos como `alt_disk_copy`, `bootlist`, `bosboot`, `varyonvg` o cambios de paths pueden afectar al arranque o a volumenes en uso. Antes de tocar nada, valida discos con `lspv`, grupos con `lsvg`, paths activos y si hay PowerHA o cluster implicado. Si es produccion, deja salida de estado antes y despues.
...
mirrorvg <VG> <DISCO>
bosboot -ad <DISCO>
bootlist -m normal <DISCO1> <DISCO2>
```
