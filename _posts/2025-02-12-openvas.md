...
Si cambias la consola para escuchar en `0.0.0.0`, la abres a la red. Hazlo solo en redes confiables, con firewall limitado a IPs concretas y contraseña fuerte. Si puedes, pon TLS o un reverse proxy delante y revisa logs tras reiniciar.
