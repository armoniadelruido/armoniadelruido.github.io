...
Los comandos de desconexion o borrado en cabinas pueden dejar un host sin disco o marcar volumenes para destruccion. Antes de ejecutar `disconnect`, `destroy` o cambios de pods, valida host, hostgroup, volumen, multipath y que no haya I/O activo. Si es un entorno importante, mejor hacerlo con una ventana acordada y rollback claro.
