...
## Consolidacion de apuntes

<!-- Fuentes integradas o revisadas: `YUM.txt`, `yummy_sh.txt`, `updates_redhat.txt`, `actualizaciones_maquinas.txt`, `Red-Hat_BSA-Basic-Instalation-Guide.txt`. -->

### Comandos recurrentes saneados
...
### Activar repositorio concreto para una accion
